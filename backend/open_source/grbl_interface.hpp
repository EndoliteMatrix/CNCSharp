...
class GrblInterface : public Communication {
public:
    GrblInterface(const std::string& port, unsigned long baud);
    virtual ~GrblInterface();
    ...
    // Send an IR program to a GRBL controller.
